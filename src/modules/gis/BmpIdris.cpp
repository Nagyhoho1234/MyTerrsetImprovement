...
class BmpIdrisModule : public Module {
public:
    QString name() const override { return "BMPIDRIS"; }
    QString description() const override {
        return "Convert between BMP and TerrSet raster format.";
    }
    ...
    std::vector<ParameterDef> parameterDefs() const override {
        return {
            ...
            ParameterDef::combo("direction", "Direction",
                {"BMP to TerrSet", "TerrSet to BMP"}, 0),
        };
    }
...
REGISTER_MODULE(BmpIdrisModule)
