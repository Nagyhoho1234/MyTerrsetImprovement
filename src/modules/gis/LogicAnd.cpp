...
class LogicAndModule : public Module {
public:
    QString name() const override { return "LOGICAND"; }
    QString description() const override {
        return "Logical AND overlay. Output is 1 where both inputs are non-zero, else 0.";
    }
    ...
    bool execute() override {
        ...
        for (int64_t i = 0; i < total; ++i) {
            ...
            out[i] = (d1[i] != 0.0 && d2[i] != 0.0) ? 1.0 : 0.0;
...
REGISTER_MODULE(LogicAndModule)
