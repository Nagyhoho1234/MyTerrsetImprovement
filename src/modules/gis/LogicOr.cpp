...
class LogicOrModule : public Module {
public:
    QString name() const override { return "LOGICOR"; }
    QString description() const override {
        return "Logical OR overlay. Output is 1 where either input is non-zero, else 0.";
    }
