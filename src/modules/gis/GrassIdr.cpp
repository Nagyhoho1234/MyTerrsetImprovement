...
class GrassIdrModule : public Module {
public:
    QString name() const override { return "GRASSIDR"; }
    QString description() const override {
        return "Convert between GRASS GIS raster format and TerrSet raster format.";
    }
    ...
    std::vector<ParameterDef> parameterDefs() const override {
        return {
            ...
            ParameterDef::combo("direction", "Direction",
                {"GRASS to TerrSet", "TerrSet to GRASS"}, 0),
        };
    }
    ...
    bool execute() override {
        ...
        QString driver = (dir == 0) ? "RST" : "GRASS";
...
REGISTER_MODULE(GrassIdrModule)
