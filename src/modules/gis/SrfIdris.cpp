...
class SrfIdrisModule : public Module {
public:
    QString name() const override { return "SRFIDRIS"; }
    QString description() const override {
        return "Convert between Golden Software Surfer grid and TerrSet raster format.";
    }
    ...
    std::vector<ParameterDef> parameterDefs() const override {
        return {
            ...
            ParameterDef::combo("direction", "Direction",
                {"Surfer to TerrSet", "TerrSet to Surfer"}, 0),
        };
    }
...
REGISTER_MODULE(SrfIdrisModule)
